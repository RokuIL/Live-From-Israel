...
$ChannelList = @(
    ...
    @{ Title = "Fox News Channel";          TitleEng = "Fox News Channel";          GroupTitle = "US News"; EPGProvider = "WGP.ENG"; EPGStationId = "465372";            EPGBackupProvider = "XMLTV";  EPGBackupStationId = "fox-news-hd";                 Logo = "" }
    ...
    @{ Title = "FOX 5 New York NY (WNYW)";  TitleEng = "FOX 5 New York NY (WNYW)";  GroupTitle = "US News"; EPGProvider = "WGP.ENG"; EPGStationId = "469512";            EPGBackupProvider = "";       EPGBackupStationId = "";                            Logo = "https://raw.githubusercontent.com/RokuIL/Live-From-Israel/master/Logos/FOXNY.png" }
    ...
    @{ Title = "MLB";                       TitleEng = "MLB";                       GroupTitle = "Sports";  EPGProvider = "XMLTV";   EPGStationId = "mlb-network-us-hd"; EPGBackupProvider = "";       EPGBackupStationId = "";                            Logo = "" }
    @{ Title = "MLB Channel";               TitleEng = "MLB";                       GroupTitle = "Sports";  EPGProvider = "XMLTV";   EPGStationId = "mlb-network-us-hd"; EPGBackupProvider = "";       EPGBackupStationId = "";                            Logo = "" }
