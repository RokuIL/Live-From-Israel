...
$ChannelList = @(
    ...
    @{ Title = "FOX Sports";                TitleEng = "FOX Sports";                GroupTitle = "Sports";  EPGProvider = "WGP.ENG"; EPGStationId = "558128";      EPGBackupProvider = "";       EPGBackupStationId = "";                            Logo = "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/FOX_Sports_logo.svg/960px-FOX_Sports_logo.svg.png" }
